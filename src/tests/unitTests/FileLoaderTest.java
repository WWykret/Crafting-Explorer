...
class FileLoaderTest {
    ...
    void loadFiles() {
        ...
        Recepture stickRec = new Recepture(0, Utils.CraftingType.craft3x3, new ArrayList<>(Arrays.asList(oakPlank, null, null, oakPlank, null, null, null, null, null)),stick, 4);
        Recepture torchRec1 = new Recepture(0, Utils.CraftingType.craft3x3, new ArrayList<>(Arrays.asList(coal, null, null, stick, null, null, null, null, null)),torch, 4);
        Recepture torchRec2 = new Recepture(0, Utils.CraftingType.craft3x3, new ArrayList<>(Arrays.asList(charcoal, null, null, stick, null, null, null, null, null)),torch, 4);
